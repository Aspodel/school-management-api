...
namespace SchoolManagement.Core.Migrations
{
    ...
    [Migration("20210415183256_ChangeNullStatus")]
    partial class ChangeNullStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassStudent", b =>
                {
                    b.HasOne("SchoolManagement.Core.Entities.Class", null)
                        .WithMany()
                        .HasForeignKey("ClassesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolManagement.Core.Entities.Student", null)
                        .WithMany()
